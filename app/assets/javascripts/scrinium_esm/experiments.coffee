...
$(document).on 'page:change', ->
  ...
  $('a#info').click ->
    ...
    $('div#logs').hide()
    $('#add-log').hide()
    $('div#diagnostic-results').hide()
    $('#add-diagnostic-result').hide()
    $('div#ensemble-members').hide()
    $('#add-ensemble-member').hide()
  $('a#logs').click ->
    $('div#info').hide()
    $('div#logs').show()
    $('#add-log').show()
    ...
    $('div#ensemble-members').hide()
    $('#add-ensemble-member').hide()
  $('a#diagnostic-results').click ->
    $('div#info').hide()
    $('div#logs').hide()
    $('#add-log').hide()
    $('div#diagnostic-results').show()
    $('#add-diagnostic-result').show()
    $('div#ensemble-members').hide()
    $('#add-ensemble-member').hide()
  $('a#ensemble-members').click ->
    $('div#info').hide()
    $('div#logs').hide()
    $('#add-log').hide()
    $('div#diagnostic-results').hide()
    $('#add-diagnostic-result').hide()
    $('div#ensemble-members').show()
    $('#add-ensemble-member').show()
